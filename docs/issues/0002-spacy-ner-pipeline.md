...
## Acceptance criteria
- [ ] `spacy` library and `en_core_web_sm` model integrated.
- [ ] Preprocessing functions clean, normalize, and extract entities correctly.
- [ ] `main.py --mode classify` outputs the risk classification *and* a formatted list of all extracted entities.
- [ ] `tests/test_pipeline.py` contains automated assertions for spaCy cleaning and entity detection boundaries.
